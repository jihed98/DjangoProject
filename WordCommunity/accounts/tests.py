...
class LogInTest(TestCase):
    ...
    '''
    Testiamo se tutti i form per la registrazione sono obbligatori
    e che si rimanga sulla pagina di registrazione
    Inseriamo due password diverse per vedere se il form ritorna un errore
    Infine inseriamo dei valori validi e ci accertiamo che vengano accettati 
    '''
    ...
    Poi inseriamo delle credenziali false per vedere se il sistema rifuta il login
    '''
    def test_login(self):
